...
```mermaid
flowchart LR
    A["Packet Capture<br/><i>Scapy sniff()</i>"] --> B["Parser /<br/>Feature Extraction"]
    B --> C["Detection Rules Engine<br/><i>port scan, SYN flood,<br/>ARP spoof</i>"]
    C --> D["Alerting<br/><i>console + rotating log file</i>"]
```
